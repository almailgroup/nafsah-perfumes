    ...
    <footer id="contact" className="scroll-mt-24 border-t hairline bg-ink-950">
      ...
      <div className="border-b hairline">
        <div className="mx-auto grid max-w-7xl gap-8 px-5 py-16 sm:px-8 lg:grid-cols-2 lg:items-center">
          <div>
            ...
            <h2 className="mt-4 font-display text-3xl font-light leading-tight text-cream-50 sm:text-4xl">
      ...
      <div className="mx-auto max-w-7xl px-5 py-14 sm:px-8">
        <div className="grid gap-10 md:grid-cols-[1.4fr_repeat(3,1fr)]">
          <div>
            <div className="flex items-center gap-3">
              <span className="grid h-9 w-9 place-items-center rounded-full border border-gold-400/40">
                <span className="font-display text-lg leading-none text-gold-300">N</span>
              </span>
              <span className="font-display text-xl tracking-[0.18em] text-cream-50">NAFSAH</span>
            </div>
            <p className="mt-5 max-w-xs text-[13px] leading-relaxed text-cream-400">
              Maison de parfum, founded 1974. Composed in Grasse, bottled in small batches, shipped
              worldwide.
            </p>

            <ul className="mt-6 space-y-2.5 text-[13px] text-cream-400">
              <li className="flex items-center gap-2.5">
                <MapPin className="h-3.5 w-3.5 shrink-0 text-gold-400" strokeWidth={1.5} />
                12 Boulevard du Jeu de Ballon, Grasse
              </li>
              <li className="flex items-center gap-2.5">
                <Mail className="h-3.5 w-3.5 shrink-0 text-gold-400" strokeWidth={1.5} />
                atelier@nafsah.example
              </li>
              <li className="flex items-center gap-2.5">
                <Phone className="h-3.5 w-3.5 shrink-0 text-gold-400" strokeWidth={1.5} />
                +33 4 93 00 00 00
              </li>
            </ul>
          </div>
          ...
          {COLUMNS.map((column) => (
            <div key={column.title}>
              <h3 className="text-[10px] font-medium uppercase tracking-wider2 text-cream-200">
                {column.title}
              </h3>
              <ul className="mt-5 space-y-3">
                {column.links.map((link) => (
                  <li key={link}>
                    <a
                      href="#collection"
                      className="text-[13px] text-cream-400 transition-colors duration-300 hover:text-gold-300"
                    >
                      {link}
                    </a>
                  </li>
        ...
        <div className="mt-12 flex flex-col items-center justify-between gap-5 border-t hairline pt-8 sm:flex-row">
          <p className="text-[11px] tracking-wide text-cream-400">
          ...
          <div className="flex items-center gap-5">
            <a
              ...
              className="text-cream-400 transition-colors duration-300 hover:text-gold-300"
            >
            ...
            <a
              href="#collection"
              className="text-[11px] uppercase tracking-wider2 text-cream-400 transition-colors duration-300 hover:text-gold-300"
            >
              Privacy
            </a>
            <a
